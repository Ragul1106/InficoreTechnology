...
const testimonials = [
  {
    name: "Maghizhan",
    review: "The practical sessions and industry projects helped me gain real confidence."
  },
  {
    name: "Libi",
  ...
  {
    name: "Nandhini",
    review: "The hands-on training gave me confidence to work on real projects."
  },
  {
    name: "Arun Kumar",
...
<template>
  ...
  <section class="bg-gradient-to-r from-slate-900 via-sky-900 to-slate-900 text-white">
    ...
    <div class="max-w-7xl mx-auto px-6 py-16">
      ...
      <div class="grid lg:grid-cols-3 gap-10">
        ...
        <div class="lg:col-span-2">
          ...
          <h1
            class="mt-6 text-4xl md:text-5xl font-extrabold leading-tight"
          >
            {{ course.title }}
          </h1>

          <p
            class="mt-6 text-lg text-slate-300 leading-relaxed max-w-3xl"
          >
            {{ course.overview }}
          </p>
...
<section class="max-w-7xl mx-auto px-6 py-16">
  ...
  <div class="flex items-center justify-between mb-10">
    <div>
      <p class="text-sky-600 font-semibold uppercase tracking-wider text-sm">
        Course Modules
      </p>
  ...
  <div class="grid lg:grid-cols-2 gap-6">
    ...
    <div class="space-y-5">
      <template
        v-for="(topic, index) in course.topics.filter((_, i) => i % 2 === 0)"
        :key="topic"
      >
        <div
    ...
    <div class="space-y-5">
      <template
        v-for="(topic, index) in course.topics.filter((_, i) => i % 2 === 1)"
        :key="topic"
      >
        <div
          class="flex gap-5 p-5 bg-white rounded-2xl border border-slate-200 shadow-sm hover:shadow-lg transition"
...
Build strong theoretical concepts.
...
Students, graduates and working professionals interested in this domain.
...
Yes. Every student receives an InfiCoreWare Course Completion Certificate.
...
Join InfiCoreWare Technologies and gain practical skills with industry experts, real projects, certification and placement support.
